...
const AvatarStyled = styled(Avatar)(({ theme }: any) => ({
  width: theme.reactCommentsMui?.avatarSize || 32,
  height: theme.reactCommentsMui?.avatarSize || 32,
}));

const CommentCard = styled(Paper)(({ theme }: any) => ({
  padding: theme.spacing(1),
  borderRadius: theme.reactCommentsMui?.cardBorderRadius || 8,
    ...
    <CommentContainer ref={parentContainerRef} className="comment-container">
      ...
      <div>
        ...
        <Actions>
          ...
          <Typography variant="body2" color="text.secondary">{comment.likes}</Typography>
